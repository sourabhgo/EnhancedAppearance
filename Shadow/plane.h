...
namespace planeNS
{
    ...
    const int   SHADOW_Y = GAME_HEIGHT/2;   // the shadow's Y coordinate
    const int   PLANE_MAX_Y = SHADOW_Y - 10; // the plane's maximum Y coordinate
...
{
private:
    Image   shadow;         // the plane's shadow
